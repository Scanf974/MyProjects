...
def initialiser():
	can.create_rectangle(10, 10, 50, 50, outline="white", fill='red')
	can.create_oval(100, 10, 140, 70, outline="blue", fill='green')
...
texte.insert(Tkinter.END,'touches : 4,6 et Q.  Graphisme : Chloé H ')
