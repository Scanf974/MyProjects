...
def teste_col(y,x):
	...
	if (x>pxg and x<(pxg+64) and y>pyg and y<(pyg+64))  or ((x+60)>pxg and (x+60)<(pxg+64) and y>pyg and y<(pyg+64))  or (x>pxg and x<(pxg+64) and (y+60)>pyg and (y+60)<(pyg+64))  or  ((x+60)>pxg and (x+60)<(pxg+64) and (y+60)>pyg and (y+60)<(pyg+64)):     #pour le 4 coins du birds
		can.delete(mac)
		stop3()
...
def teste_col2(y,x):
	...
	if (x>pxg2 and x<(pxg2+64) and y>pyg2 and y<(pyg2+64))  or ((x+60)>pxg2 and (x+60)<(pxg2+64) and y>pyg2 and y<(pyg2+64))  or (x>pxg2 and x<(pxg2+64) and (y+60)>pyg2 and (y+60)<(pyg2+64))  or  ((x+60)>pxg2 and (x+60)<(pxg2+64) and (y+60)>pyg2 and (y+60)<(pyg2+64)):     #pour le 4 coins du birds
		can.delete(mac2)
		stop3_2()
