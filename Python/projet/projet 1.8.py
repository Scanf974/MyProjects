...
def pos_bird():
	...
	f1 = can.create_image(lx-vx0*0.0+30, ly+vy0*0.0+30, image=image_fum2, anchor=NW)
	f2 = can.create_image(lx-vx0*0.3+30, ly+vy0*0.3+30, image=image_fum2, anchor=NW)
	f3 = can.create_image(lx-vx0*0.6+30, ly+vy0*0.6+30, image=image_fum2, anchor=NW)
	f3 = can.create_image(lx-vx0*0.9+30, ly+vy0*0.9+30, image=image_fum2, anchor=NW)
	
	image_lanceur2 = ImageTk.PhotoImage(file='img/lanceur2.png')							#le lanceur
	lanceur2 = can.create_image(181, 235, image=image_lanceur2, anchor=NW)
	...
	lanceur = can.create_image(100, 228, image=image_lanceur, anchor=NW)
...
def stop():
	global px0,py0,angr,angd,v0,vx0,vy0,flag1,ab,v1
...
vy0 = sin(angr)*v0	#.../seconde
v1 = v0
e = 0.5				#coefficient de rebond du sol
		
tps = 0				#seconde

lx = 120
ly = 210
px0 = lx-vx0*1.2			#position initiale sur x
py0 = ly+vy0*1.2			#position initiale sur y
