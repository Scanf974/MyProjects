...
def teste_sol(y,x):
	...
	if flag1==1:
		if pyo>=482:
			py3 =  pu*pxo*pxo - 2.5*a*pxo + 482 + 600*a*a		#->
...
image_ld = ImageTk.PhotoImage(file='Loading.gif')						
ld = can.create_image(0, 0, image=image_ld, anchor=NW)

image_ab = ImageTk.PhotoImage(file='ab.png')							#les birds
ab = can.create_image(pxo, pyo, image=image_ab, anchor=NW)


image_mac = ImageTk.PhotoImage(file='mac.png')							#les dechets
