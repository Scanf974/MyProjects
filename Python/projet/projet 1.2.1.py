...
def img1():
	global pxo,pyo,image_ab,ab
	
	image_ab = ImageTk.PhotoImage(file='ab.png')
...
pxp = 10																#pxp = vitesse sur x initial
...
timer_deplace = MyTimer(0.035,deplace)
