...
def deplace():
	global px,py,vx0,vy0,px0,py0,tps,flag1,angd,angr,v0,v1,e,lx,ly,lvl,rebon
...
def pos_bird():
	global image_ab,ab,py0,px0,lx,ly
...
def tirer(x,y):
	global px,py,tps,flag1,image_fum,fum,v1,v0,angr,angd,vx0,vy0,combo
