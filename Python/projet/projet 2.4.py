...
def deplace_gland():
	...
	if pxg < 1200 and pyg < 326:		
		...
		vg0 = random.randint(80.0,110.0+lvl)		#pixels/seconde
...
def tire_gland():
	global pxg,pyg,tpg,image_mac,mac,vg0,anggd,anggr,vxg0,vyg0,nbg,lvl
...
timer_niveau = MyTimer(10.0,niveau)
...
image_logo = ImageTk.PhotoImage(file='img/logo.png')							#les dechets
