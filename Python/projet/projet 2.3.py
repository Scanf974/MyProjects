...
def teste_col(y,x):
	global pxg0,pyg0
	if flag1<>0:
		if x>pxg0 and x<pxg0+64 and y>pyg0 and y<pyg0+64  or x+60>pxg0 and x<pxg0+64 and y>pyg0 and y<pyg0+64  or x>pxg0 and x<pxg0+64 and y>pyg0 and y<pyg0+64  or  x+60>pxg0 and x+60<pxg0+64 and y+60>pyg0 and y+60<pyg0+64:     #pour le 4 coins du birds
			can.delete(mac)
...
def deplace_gland():
	global pxg0,pyg0,tpg,vg0,anggd,anggr,vxg0,vyg0,pxg,pyg	
	...
	if pxg < 1200 and pyg < 326:		
		...
		vg0 = random.randint(90.0,110.0)		#pixels/seconde
...
def pos_bird():
	global image_ab,ab,py0,px0,lx,ly,image_fum2,f1,f2,f3,f4
...
e = 0.1					#coefficient de rebond du squirrel
...
anggd = 125			#DEGRES
anggr = 0.0174*angd	#RADIAN
vg0 = 80.0			#pixels/seconde
vxg0 = cos(anggr)*v0	#pixels/seconde
vyg0 = sin(anggr)*v0	#pixels/seconde
...
timer_deplace_gland = MyTimer(0.001,deplace_gland)
...
image_fum2 = ImageTk.PhotoImage(file='img/fum2.png')							#les points de repere
f1 = can.create_image(lx+vx0*0.00+30, ly-vy0*0.00+30, image=image_fum2, anchor=NW)
f2 = can.create_image(lx+vx0*0.25+30, ly-vy0*0.25+30, image=image_fum2, anchor=NW)
f3 = can.create_image(lx+vx0*0.50+30, ly-vy0*0.50+30, image=image_fum2, anchor=NW)
f4 = can.create_image(lx+vx0*0.75+30, ly-vy0*0.75+30, image=image_fum2, anchor=NW)
